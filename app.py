...
def visualization_data():
    ...
    philosophers = [
        ...
        ("Rene Descartes", "Racionalismo", 1637, 0, "static/img/rene_descartes.jpg", [
    ...
    works = {
        ...
        'Rene Descartes': [('Discurso do Método', '1637')],
    ...
    influences = {
        ...
        'Rene Descartes': [('Euclides', 'O método geométrico de Euclides inspirou o ideal cartesiano de conhecimento mais geométrico.', 'Concorda')],
        'Baruch Spinoza': [('Rene Descartes', 'Spinoza partiu do racionalismo cartesiano, radicalizando-o no monismo.', 'Concorda')],
        'Gottfried Wilhelm Leibniz': [('Rene Descartes', 'Leibniz expandiu o racionalismo cartesiano com a teoria das mônadas.', 'Concorda')],
        ...
        'Edmund Husserl': [('Immanuel Kant', 'A busca por uma fundamentação rigorosa do conhecimento ecoa preocupações kantianas.', 'Concorda'), ('Rene Descartes', 'A busca por um fundamento apodítico da consciência retoma o projeto cartesiano.', 'Concorda')],
        ...
        'Noam Chomsky': [('Rene Descartes', 'Retomou o inatismo cartesiano em oposição ao behaviorismo.', 'Concorda')],
        'Jerry Fodor': [('Noam Chomsky', 'Desenvolveu teorias cognitivas inspiradas no inatismo chomskyano.', 'Concorda'), ('Rene Descartes', 'Defendeu formas de inatismo cognitivo na linhagem cartesiana.', 'Concorda')],
        'David Chalmers': [('Rene Descartes', 'Retoma o dualismo na discussão contemporânea sobre a consciência.', 'Concorda'), ('Frank Jackson', 'Incorporou argumentos como o do "quarto de Mary" na defesa do dualismo de propriedades.', 'Concorda'), ('Thomas Nagel', 'Baseou-se na pergunta "o que é ser um morcego?" para formular o problema difícil.', 'Concorda')],
    }
    ...
    adepts = {
        ...
        'Rene Descartes': [('Baruch Spinoza', 'Desenvolveu o racionalismo em um sistema monista.'), ('Gottfried Wilhelm Leibniz', 'Expandiu o racionalismo com a teoria das mônadas.')],
    ...
    oppositions = {
        ...
        'John Locke': [('Rene Descartes', 'Criticava a negação das ideias inatas e defendia que certos conhecimentos são anteriores à experiência.')],
        ...
        'Rene Descartes': [('Francis Bacon', 'Criticava a confiança excessiva na experiência sensível.')],
